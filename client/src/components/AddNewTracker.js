  ...
  return (
    <div className={`new-tracker ${className}`}>
      ...
      <Button
        ...
        sx={{
          color: "#2c8ff2", // Text color for outlined button
          borderColor: "#2c8ff2", // Border color for outlined button
          "&:hover": {
            backgroundColor: "rgba(44, 143, 242, 0.1)", // Light background on hover
            borderColor: "#1e7ac6", // Darker border color on hover
          },
        }}
      >
        Add new tracker
